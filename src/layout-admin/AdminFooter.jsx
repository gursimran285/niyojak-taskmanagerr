        ...
        <div className="container">
          <div className="row text-center text-md-start">
            <div className="col-md-4 mb-4">
              <h4 className="fw-bold text-white">NIYO<span style={{ color: "#F1A208" }}>JAK</span> Admin</h4>
            ...
            <div className="col-md-4 mb-4">
              ...
              <ul className="list-unstyled mt-3">
                {["Dashboard", "Add Employee", "Manage Projects","Assign Task"].map((link, idx) => (
          ...
          <div className="row">
            <div className="col-md-6 text-center text-md-start">
              <span className="text-light">
                &copy; {new Date().getFullYear()} Niyojak Admin Panel. All rights reserved.
              </span>
            </div>
          </div>
        </div>
